...
@section("name") Analizador de Tweets @endsection
    ...
    <div class="col-lg-12">
        <div class="view-header">
            <div class="header-icon">
                <i class="fa page-header-icon fa-twitter"></i>
            </div>
            <div class="header-title">
                <h3 class="m-b-xs">Tweets Analyzer</h3>
                <small>
                    Aplicación web para el análisis de Tweets mediante Personality Insights de Watson.
                </small>
            </div>
        </div>
        <hr>
